 ...
 */
public class LatencyPerContactReport extends Report implements MessageListener, ConnectionListener{
     ...
     * Constructor.
     */
    public LatencyPerContactReport() {
        init();
    }
    ...
    @Override
    public void done() {
        String statsText = "Latencies/Contact\n";
