...
public class MessageStatsReportperTime extends Report implements MessageListener, UpdateListener {
	...
	private double lastRecord = Double.MIN_VALUE;
        private Map<Integer, Integer> nrofTerkirim;
...
//                write("NrofDelivered/Time = ");
                String temp = "";
                for (Map.Entry<Integer, Integer> entry : nrofTerkirim.entrySet()) {
    ...
    public void updated(List<DTNHost> hosts) {
		...
		if (simTime - lastRecord >= interval) {
                    nrofTerkirim.put((int) simTime, nrofDelivered);
