...
public class ConvergenceTimeReport extends Report implements UpdateListener {
     ...
     */
    public static final int DEFAULT_WAKTU = 600;
    private double lastRecord = Double.MIN_VALUE;
    private int interval;
    private Map<DTNHost, ArrayList<Integer>> ListNode = new HashMap<DTNHost, ArrayList<Integer>>();
