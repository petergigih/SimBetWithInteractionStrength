...
public class SimBetWFairRoute implements RoutingDecisionEngine, SimilarityDetectionEngine {
    ...
    private static final Double R_LAMBDA_DEFAULT = 0.1;//ditung
    ...
    public SimBetWFairRoute(SimBetWFairRoute proto) {
    ...
    public void buildIndirectNodeMatrix(Map<DTNHost, Set<DTNHost>> neighboursNode, DTNHost dest) {
        ...
        for (int i = 0; i < dummyArrayN.size(); i++) {
            for (int j = 0; j < 1; j++) {
                if (i==0) {
                  ...
                  //  double values = countAgrIntStrength(neighborsHistory);
                    neighboursAdj[i][j] = 1;
       ...
       // System.out.println(neighboursAdj);
    }
    ...
    protected void buildEgoNetwork(Map<DTNHost, Set<DTNHost>> neighboursNode, DTNHost host) {
        ...
        SimBetWFairRoute hostDE = getOtherDecisionEngine(host);
...
//                    System.out.println(lamda+" "+sigma);
                    double value = hostDE.countAgrIntStrength(hostDE.neighborsHistory);
...
//                   System.out.println(value);
       ...
       // System.out.println(matrixEgoNetwork);
    }
