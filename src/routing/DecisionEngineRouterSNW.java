 ...
 */
public class DecisionEngineRouterSNW extends ActiveRouter
{
	public static final String PUBSUB_NS = "DecisionEngineRouterSNW";
	...
	public DecisionEngineRouterSNW(Settings s)
	{
		super(s);
	...
	public DecisionEngineRouterSNW(DecisionEngineRouterSNW r)
	{
		super(r);
		outgoingMessages = new LinkedList<Tuple<Message, Connection>>();
	...
	{
		return new DecisionEngineRouterSNW(this);
	}
	...
	public void changedConnection(Connection con)
	{
		...
		DecisionEngineRouterSNW otherRouter = (DecisionEngineRouterSNW)otherNode.getRouter();
		if(con.isUp())
		{
